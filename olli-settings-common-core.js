...
function settingsApplyStateToUI() {
  ...
  if (typeof updateSettingsGroupFeedbackMonthsValue === 'function') updateSettingsGroupFeedbackMonthsValue();
...
/* settings page/sheet UI moved to platform-specific files. */
